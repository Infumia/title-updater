...
import net.minecraft.server.v1_11_R1.ChatTypeAdapterFactory;
...
public final class NmsV1_11_2 implements Nms {

    public static final Nms INSTANCE = new NmsV1_11_2();
    ...
    private IChatBaseComponent toComponent(final Object text) {
        ...
        if (text instanceof String) {
            ...
            component = NmsV1_11_2.GSON.fromJson((JsonElement) text, IChatBaseComponent.class);
        }
        return component;
    }
