...
import net.minecraft.server.v1_10_R1.ChatTypeAdapterFactory;
...
public final class NmsV1_10_2 implements Nms {

    public static final Nms INSTANCE = new NmsV1_10_2();
    ...
    private IChatBaseComponent toComponent(final Object text) {
        ...
        if (text instanceof String) {
            ...
            component = NmsV1_10_2.GSON.fromJson((JsonElement) text, IChatBaseComponent.class);
        }
        return component;
    }
